...
public class BluetoothAddressFacet extends MACAddressFacet {
    public static final String CLASS_IRI = "https://ontology.unifiedcyberontology.org/uco/observable/BluetoothAddressFacet";
    public static final String NAMESPACE_PREFIX = "uco-observable";


    public BluetoothAddressFacet() {
    }
