...
public class EmailAddressFacet extends DigitalAddressFacet {
    public static final String CLASS_IRI = "https://ontology.unifiedcyberontology.org/uco/observable/EmailAddressFacet";
    public static final String NAMESPACE_PREFIX = "uco-observable";


    public EmailAddressFacet() {
    }
