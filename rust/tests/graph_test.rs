...
fn test_serialize_produces_valid_json() {
    ...
    graph.add("Tool", Tool::CLASS_IRI, &tool);
...
fn test_typed_boolean_literals() {
    ...
    graph.add("ObservableObject", ObservableObject::CLASS_IRI, &observable);
...
fn test_multiple_objects() {
    ...
    graph.add("Tool", Tool::CLASS_IRI, &t1);
    graph.add("Tool", Tool::CLASS_IRI, &t2);
