...
namespace CaseUco.Uco.Action
{
    ...
    {
        public const string ClassIri = "https://ontology.unifiedcyberontology.org/uco/action/Action";
        public const string NamespacePrefix = "uco-action";
    ...
    {
        public const string ClassIri = "https://ontology.unifiedcyberontology.org/uco/action/ActionArgumentFacet";
        public const string NamespacePrefix = "uco-action";
    ...
    {
        public const string ClassIri = "https://ontology.unifiedcyberontology.org/uco/action/ActionEstimationFacet";
        public const string NamespacePrefix = "uco-action";
    ...
    {
        public const string ClassIri = "https://ontology.unifiedcyberontology.org/uco/action/ActionFrequencyFacet";
        public const string NamespacePrefix = "uco-action";
    ...
    {
        public const string ClassIri = "https://ontology.unifiedcyberontology.org/uco/action/ActionLifecycle";
        public const string NamespacePrefix = "uco-action";
    ...
    {
        public const string ClassIri = "https://ontology.unifiedcyberontology.org/uco/action/ActionPattern";
        public const string NamespacePrefix = "uco-action";
    }
    ...
    {
        public const string ClassIri = "https://ontology.unifiedcyberontology.org/uco/action/ArrayOfAction";
        public const string NamespacePrefix = "uco-action";
