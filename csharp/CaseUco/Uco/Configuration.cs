...
namespace CaseUco.Uco.Configuration
{
    ...
    {
        public const string ClassIri = "https://ontology.unifiedcyberontology.org/uco/configuration/Configuration";
        public const string NamespacePrefix = "uco-configuration";
    ...
    {
        public const string ClassIri = "https://ontology.unifiedcyberontology.org/uco/configuration/ConfigurationEntry";
        public const string NamespacePrefix = "uco-configuration";
    ...
    {
        public const string ClassIri = "https://ontology.unifiedcyberontology.org/uco/configuration/Dependency";
        public const string NamespacePrefix = "uco-configuration";
